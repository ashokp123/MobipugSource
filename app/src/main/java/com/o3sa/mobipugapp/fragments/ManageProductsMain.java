...
public class ManageProductsMain extends Fragment {
    ...
    public void intialization(View v){
        StoredObjects.pagetype="manageproducts";
        ...
        components.CustomizeTextview(Sidemenu.menu_title, Constants.XXLarge4,R.color.black,getActivity().getResources().getString(R.string.product_list),Constants.WrapLeftBold+Constants.Gibson, new int[]{0,0,0,0});
        ...
        if(StoredObjects.proviewpos==0){
            fragmentcalling(getActivity(),new ProductList());
            buttonchangemethod(getActivity(),ofrmn_ofrs_lay,ofrmn_ofrslist_txt,ofrmn_ofrs_view,"0");
        }else if(StoredObjects.proviewpos==1){
            fragmentcalling(getActivity(),new AddProduct());
            buttonchangemethod(getActivity(),ofrmn_adofr_lay,ofrmn_adofr_txt,ofrmn_adofr_view,"1");
        }else{
            fragmentcalling(getActivity(),new ManageProducts());
    ...
    public void assigndata(){
        ...
        components.CustomizeTextview(ofrmn_ofrslist_txt, Constants.Medium,R.color.txt_clr,getActivity().getApplicationContext().getResources().getString(R.string.product_list),Constants.WrapCenterBold+Constants.Gibson, new int[]{0,10,0,10});
        components.CustomizeTextview(ofrmn_adofr_txt, Constants.Medium,R.color.thik_grey,getActivity().getApplicationContext().getResources().getString(R.string.add_product),Constants.WrapCenterBold+Constants.Gibson, new int[]{0,10,0,10});
