...
public class ManageCategoriesMain extends Fragment {
    ...
    public void intialization(View v){
        StoredObjects.pagetype="managecategories";
        ...
        fragmentcalling(getActivity(),new VendorCategorieslist());
        components.CustomizeTextview(Sidemenu.menu_title, Constants.XXLarge4,R.color.black,getActivity().getResources().getString(R.string.category_lst),Constants.WrapLeftBold+Constants.Gibson, new int[]{0,0,0,0});
        ...
        layout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (type.equalsIgnoreCase("0")) {
                    ...
                    fragmentcalling(getActivity(),new VendorAddCategory());
                    ...
                    fragmentcalling(getActivity(),new VendorManageCategory());
                }
            }
        });
    ...
    public void assigndata(){
        ...
        components.CustomizeTextview(ofrmn_ofrslist_txt, Constants.Medium,R.color.txt_clr,getActivity().getApplicationContext().getResources().getString(R.string.my_categories),Constants.WrapCenterBold+Constants.Gibson, new int[]{0,10,0,10});
