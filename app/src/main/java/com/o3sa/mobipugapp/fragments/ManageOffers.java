...
public class ManageOffers extends Fragment {
    ...
    public void intialization(View v) {
        ...
        StoredObjects.pagetype="v_manageofferlist";
    ...
    private void Offersfilterpopup(LinearLayout viewpager_lay) {
        ...
        select_ctgry_lay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CategoryFilterPopup(ctgry_edtx,select_ctgry_lay);
            }
        });
                ...
                if(StoredObjects.Services_list.get(val).Result != ""){
                    ...
                    if(val==0) {
                        try {
                            ...
                            recyclerview.Assigndatatorecyleviewhashmap(ofrs_recycleviwe,offerslist,"manageoffers",
                                    Constants.Listview, 0, Constants.ver_orientation,R.layout.manageofrs_listitem);
