...
public class ZBarScannerActivity extends Activity implements Camera.PreviewCallback, ZBarConstants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);//FLAG_FULLSCREEN
        ...
        mPreview = new CameraPreview(this, this, autoFocusCB);//autoFocusCB
        ...
        Toolbar bar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.t, layout, false);
